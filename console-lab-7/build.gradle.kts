...
dependencies {
    ...
    implementation("org.apache.juddi:juddi-client:3.3.9")
    implementation("org.apache.juddi:juddi-core:3.3.9")
...
val wsdlUrl = "http://localhost:9090/EmployeeService?wsdl"
//
