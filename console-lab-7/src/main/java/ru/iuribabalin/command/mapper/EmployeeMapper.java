...
public class EmployeeMapper {
    ...
    public static String mapToString(EmployeeResponseDto employee) {
        try {
            return "Employee -> " + "\n" +
                    "\t Id: " + employee.getId() + "\n" +
                    "\t Name: " + employee.getFirstName() + "\n" +
    ...
    public static EmployeeRequestDto mapToRestRequestCreate(Employee employee) {
        EmployeeRequestDto request = new EmployeeRequestDto();
        request.setFirstName(employee.getFirstName());
        request.setLastName(employee.getLastName());
        request.setPosition(employee.getPosition() != null
                ? ru.iuribabalin.client.model.Position.valueOf(employee.getPosition().name())
                : null);
        request.setDepartment(employee.getDepartment() != null
                ? ru.iuribabalin.client.model.Department.valueOf(employee.getDepartment().name())
                : null);
        request.setHireDate(employee.getHireDate());
        return request;
    }
