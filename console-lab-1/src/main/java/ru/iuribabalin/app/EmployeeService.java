 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://app.iuribabalin.ru/", wsdlLocation = "http://localhost:9090/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://app.iuribabalin.ru/", "EmployeeService");
    ...
    public EmployeeServiceImpl getEmployeeServicePort() {
        return super.getPort(new QName("http://app.iuribabalin.ru/", "EmployeeServicePort"), EmployeeServiceImpl.class);
    }
    ...
    public EmployeeServiceImpl getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://app.iuribabalin.ru/", "EmployeeServicePort"), EmployeeServiceImpl.class, features);
    }
